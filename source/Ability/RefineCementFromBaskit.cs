...
{
    public class RefineCementFromBaskit : MakeRecipe
    {
        public RefineCementFromBaskit(AbilityRecipe recept, IOwnedTokenWithAbilites owner, int id) : base(recept, owner, id)
        {
            Name = "Make Cement Baskit";
        }
    ...
    public class RefineCementFromBaskitRecept: AbilityRecipe
    {
        public RefineCementFromBaskitRecept(Player player)
        {
